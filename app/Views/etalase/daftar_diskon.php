                ...
                <div class="col-sm col-md-5 py-5 pt-md-0">
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <input type="hidden" class="form-control" id="stok" name="stok" placeholder="Enter stok" value="<?= $promo['stok']; ?>" disabled>
                            </div>
                            <div class=" form-group">
                                <label for="sisa">Sisa Kuota</label>
                                <input type="text" class="form-control" id="sisa" name="sisa" value="<?= $promo['stok']; ?>" disabled>
                            </div>
                            <div class=" form-group">
...
<script>
    ...
    $("#jumlah").on("change", function() {
        ...
        var sisa = (stok - jumlah_pembelian);
        $("#sisa").val(sisa);
    });
    ...
    $(document).ready(function() {
        ...
        $(document).delegate('#btnSave', 'click', function() {
            ...
            var id_promo = $('#id_banner').val();
            var stok = $('#sisa').val();

            let formData = new FormData();
            formData.append('id_promo', id_promo);
            formData.append('stok', stok);

            $.ajax({
                url: '<?= base_url() ?>/Transaksi/update_promo/' + id_promo,
                type: "POST",
                data: formData,
                cache: false,
                processData: false,
